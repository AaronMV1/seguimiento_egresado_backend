...
public class EncuestaRequest {
    ...
    private String fase2planificacion;
    private String fase2empresanombre;
    ...
    public int getFacultad() { return facultad; }
    ...
    public String getFase1primerempleo() { return fase1primerempleo; }
    public String getFase1medios() { return fase1medios; }
    public String getFase2satisfaccionestudios() { return fase2satisfaccionestudios; }
    public String getFase2participacion() { return fase2participacion; }
    public String getFase2satisfaccionservicio() { return fase2satisfaccionservicio; }
    public String getFase2planificacion() { return fase2planificacion; }
    public String getFase2empresanombre() { return fase2empresanombre; }
    public String getFase2empresaempleadornombre() { return fase2empresaempleadornombre; }
    public String getFase2empresaempleadorcorreo() { return fase2empresaempleadorcorreo; }
    public String getFase2empresaempleadornumero() { return fase2empresaempleadornumero; }
    public String getFase3especialidad() { return fase3especialidad; }
    ...
    public void setFacultad(int facultad) { this.facultad = facultad; }
    public void setCarrera(int carrera) { this.carrera = carrera; }
    ...
    public void setFase1primerempleo(String fase1primerempleo) { this.fase1primerempleo = fase1primerempleo; }
    public void setFase1medios(String fase1medios) { this.fase1medios = fase1medios; }
    public void setFase2satisfaccionestudios(String fase2satisfaccionestudios) { this.fase2satisfaccionestudios = fase2satisfaccionestudios; }
    public void setFase2participacion(String fase2participacion) { this.fase2participacion = fase2participacion; }
    public void setFase2satisfaccionservicio(String fase2satisfaccionservicio) { this.fase2satisfaccionservicio = fase2satisfaccionservicio; }
    public void setFase2planificacion(String fase2planificacion) { this.fase2planificacion = fase2planificacion; }
    public void setFase2empresanombre(String fase2empresanombre) { this.fase2empresanombre = fase2empresanombre; }
    public void setFase2empresaempleadornombre(String fase2empresaempleadornombre) { this.fase2empresaempleadornombre = fase2empresaempleadornombre; }
    public void setFase2empresaempleadorcorreo(String fase2empresaempleadorcorreo) { this.fase2empresaempleadorcorreo = fase2empresaempleadorcorreo; }
    public void setFase2empresaempleadornumero(String fase2empresaempleadornumero) { this.fase2empresaempleadornumero = fase2empresaempleadornumero; }
    public void setFase3especialidad(String fase3especialidad) { this.fase3especialidad = fase3especialidad; }
